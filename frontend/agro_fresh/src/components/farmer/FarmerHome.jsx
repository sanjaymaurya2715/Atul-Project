...
const FarmerHome = () => 
    {
        const URL=backendUrl+"/farmer/farmerProfile"
...
const fetchData= async()=>
  ...
  <img src={`${backendUrl}/profilePics/${profile.pic}`} className="card-img-top" alt="..." style={{width:"100%",height:"200px",objectFit:"cover",borderRadius:"10px",padding:"10px",boxShadow:"0 4px 4px rgba(0,0,0,0.1)"}}/>
